    ...
    return (
        <Layout>
            ...
            <div className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 bg-white overflow-hidden">
                ...
                <div className="absolute top-0 right-0 -mr-32 -mt-32 w-[500px] h-[500px] bg-[#277cdd]/10 rounded-lg blur-3xl z-0 pointer-events-none"></div>
                <div className="absolute bottom-0 left-0 -ml-20 w-[400px] h-[400px] bg-blue-100/40 rounded-lg blur-3xl z-0 pointer-events-none"></div>

                <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
                    <span className="text-[#277cdd] font-bold tracking-widest capitalize text-xs bg-[#277cdd]/10 px-5 py-2 rounded-lg inline-block mb-6">
                ...
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        <div className="order-2 lg:order-1 relative z-10">
                            ...
                            <div className="mt-10 flex items-center gap-5 p-6 rounded-lg bg-[#277cdd]/5 border border-[#277cdd]/10">
                                <div className="w-14 h-14 bg-white shadow-sm rounded-lg flex items-center justify-center text-[#277cdd] text-2xl flex-shrink-0">
                                    <FiTarget />
                                </div>
                                <div>
                        ...
                        <div className="order-1 lg:order-2 relative group">
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] h-[110%] bg-blue-50/50 rounded-lg blur-3xl -z-10 transition-transform duration-700 group-hover:scale-105"></div>
                            
                            <div className="relative rounded-lg overflow-hidden shadow-2xl shadow-[#277cdd]/10 border-[6px] border-white transform lg:rotate-2 group-hover:rotate-0 transition-transform duration-700 bg-gray-100">
                                <img 
                            ...
                            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-lg shadow-xl shadow-[#277cdd]/5 border border-gray-100 hidden sm:block animate-[bounce_4s_infinite]">
                                <div className="flex items-center gap-4">
                                    <div className="w-14 h-14 bg-emerald-50 rounded-lg flex items-center justify-center text-emerald-500 text-2xl">
                                        <FiThumbsUp />
                                    </div>
                                    <div>
                                        ...
                                        <p className="text-[10px] font-bold text-gray-400 capitalize tracking-widest">Kualitas Terjamin</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-20">
                <div className="bg-gradient-to-br from-[#277cdd] to-blue-600 rounded-lg shadow-2xl shadow-[#277cdd]/20 p-10 lg:p-14 overflow-hidden relative">
                    <div className="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-white/10 rounded-lg blur-2xl"></div>
                    <div className="absolute bottom-0 left-0 -mb-10 -ml-10 w-40 h-40 bg-black/10 rounded-lg blur-2xl"></div>
                    ...
                    <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-10 text-center divide-x-0 md:divide-x divide-white/10">
                        <div className="space-y-3">
                            ...
                            <p className="text-blue-100 text-sm font-semibold tracking-wider capitalize">Tahun Pengalaman</p>
                        </div>
                        <div className="space-y-3">
                            <h3 className="text-4xl lg:text-5xl font-black text-white drop-shadow-sm">
                                {about_config?.stat_clients || '200+'}
                            </h3>
                            <p className="text-blue-100 text-sm font-semibold tracking-wider capitalize">Klien Percaya</p>
                        </div>
                        <div className="space-y-3">
                            <h3 className="text-4xl lg:text-5xl font-black text-white drop-shadow-sm">
                                {about_config?.stat_products || '50K+'}
                            </h3>
                            <p className="text-blue-100 text-sm font-semibold tracking-wider capitalize">Produk Terjual</p>
                        </div>
                        <div className="space-y-3">
                            <h3 className="text-4xl lg:text-5xl font-black text-white drop-shadow-sm">
                                {about_config?.stat_satisfaction || '100%'}
                            </h3>
                            <p className="text-blue-100 text-sm font-semibold tracking-wider capitalize">Garansi Kepuasan</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="py-24 bg-white mt-10">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    <div className="text-center max-w-2xl mx-auto mb-16">
                        <span className="text-[#277cdd] font-bold tracking-widest capitalize text-xs bg-[#277cdd]/10 px-4 py-2 rounded-lg inline-block mb-4">
                            Nilai Inti
                        </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-10 rounded-lg border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-[#277cdd]/5 hover:border-[#277cdd]/20 transition-all duration-500 transform hover:-translate-y-2 group text-center">
                            <div className="w-20 h-20 mx-auto bg-blue-50 rounded-lg flex items-center justify-center text-[#277cdd] text-3xl mb-8 group-hover:scale-110 group-hover:bg-[#277cdd] group-hover:text-white transition-all duration-500">
                                <FiAward />
                            </div>
                ...
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link 
                            ...
                            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#277cdd] text-white font-bold py-4 px-8 rounded-lg hover:bg-[#1f63b3] transition-all duration-300 shadow-lg shadow-[#277cdd]/30 transform hover:-translate-y-1"
                        >
                        ...
                        <a 
                            ...
                            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white text-gray-700 border-2 border-gray-200 font-bold py-4 px-8 rounded-lg hover:border-[#277cdd]/50 hover:text-[#277cdd] hover:bg-blue-50/50 transition-all duration-300 shadow-sm"
                        >
