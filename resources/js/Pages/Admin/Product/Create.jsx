                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-3">
                                {data.specifications.map((spec, index) => (
                                    <div key={index} className="flex gap-3">
                                        <input type="text" placeholder="Label (Misal: Bahan)" className="w-1/3 rounded-lg border-slate-300 text-sm focus:border-purple-500 focus:ring-purple-500"
                                            value={spec.key} onChange={e => updateSpec(index, 'key', e.target.value)} />
                                        <input type="text" placeholder="Nilai (Misal: Cotton Combed 24s)" className="w-full rounded-lg border-slate-300 text-sm focus:border-purple-500 focus:ring-purple-500"
                                ...
                                {data.addons.map((group, gIndex) => (
                                    <div key={gIndex} className="bg-slate-50 rounded-lg p-4 border border-slate-200 relative group">
                                        ...
                                        <div className="mb-4 pr-8">
                                            <label className="text-xs font-bold text-slate-500 capitalize">Nama Grup Opsi</label>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
                            ...
                            <button disabled={processing} className="w-full flex items-center justify-center gap-2 bg-slate-900 text-white py-3 rounded-lg font-bold hover:bg-slate-800 transition-all shadow-lg shadow-slate-200">
                                <Save size={18} />
                        ...
                        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="relative aspect-square rounded-lg overflow-hidden border-2 border-dashed border-slate-300 bg-slate-50 hover:bg-slate-100 transition-colors group">
                                    {data.thumbnail ? (
