...
export default function NotificationActivity({ notifications = [] }) {
    ...
    return (
        <div className="w-80 max-h-[400px] overflow-y-auto custom-scrollbar bg-white rounded-lg shadow-2xl border border-slate-100 py-2">
            <div className="px-4 py-2 border-b border-slate-50 mb-2 flex justify-between items-center">
                <p className="text-[10px] font-black text-slate-400 capitalize tracking-widest">Aktivitas Terbaru</p>
            ...
            {notifications.length === 0 ? (
                ...
                notifications.map((notif, idx) => {
                    const Content = (
                        <div className="flex gap-3 p-3 hover:bg-slate-50 rounded-lg mx-2 transition-colors cursor-pointer group">
                            ...
                            <div className="min-w-0">
                                ...
                                <div className="flex items-center gap-1 mt-1 text-[9px] font-bold text-slate-300 capitalize tracking-tighter">
